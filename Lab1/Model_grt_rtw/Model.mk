...
## 
## Makefile     : Model.mk
## Generated on : Tue May 30 17:12:55 2017
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = //ecfile1.uwaterloo.ca/s3blanch/GitHub/ECE481/Lab1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Model_grt_rtw -I$(START_DIR) -I$(START_DIR)/Simulink -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Model -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Model_grt_rtw/Model.c $(START_DIR)/Model_grt_rtw/Model_data.c $(START_DIR)/Model_grt_rtw/rtGetInf.c $(START_DIR)/Model_grt_rtw/rtGetNaN.c $(START_DIR)/Model_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = Model.obj Model_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
